...
import './jobaRepublicResults.html';

Template.jobaRepublicResults.onCreated(function() {
    let template = this
...
Template.jobaRepublicResults.helpers({
    clickedButton() {
...
Template.jobaRepublicResults.events({
...
Template.jobaRepublicResults.onRendered(function() {
