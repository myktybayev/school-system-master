...
import './jobaInterResults.html';

Template.jobaInterResults.onCreated(function() {
    let template = this
...
Template.jobaInterResults.helpers({
    clickedButton() {
...
Template.jobaInterResults.events({
...
Template.jobaInterResults.onRendered(function() {
