...
import './olympiadRepublicResults.html';

Template.olympiadRepublicResults.onCreated(function() {
    let template = this
...
Template.olympiadRepublicResults.helpers({
    clickedButton() {
...
Template.olympiadRepublicResults.events({
...
Template.olympiadRepublicResults.onRendered(function() {
