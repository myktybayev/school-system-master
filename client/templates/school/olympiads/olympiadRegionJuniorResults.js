...
import './olympiadRegionJuniorResults.html';

Template.olympiadRegionJuniorResults.onCreated(function() {
    let template = this
...
Template.olympiadRegionJuniorResults.helpers({
    clickedButton() {
...
Template.olympiadRegionJuniorResults.events({
    ...
    "change #state"(event,template) {
        ...
        Meteor.call("Student.editPassed",this._id, event.target.value)
    },
...
Template.olympiadRegionJuniorResults.onRendered(function() {
