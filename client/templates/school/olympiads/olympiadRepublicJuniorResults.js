...
import './olympiadRepublicJuniorResults.html';

Template.olympiadRepublicJuniorResults.onCreated(function() {
    let template = this
...
Template.olympiadRepublicJuniorResults.helpers({
    clickedButton() {
...
Template.olympiadRepublicJuniorResults.events({
...
Template.olympiadRepublicJuniorResults.onRendered(function() {
