...
import './olympiadSchoolRatingInter.html';

Template.olympiadSchoolRatingInter.onCreated(function() {
    let template = this
...
Template.olympiadSchoolRatingInter.helpers({
    schools()  {
...
Template.olympiadSchoolRatingInter.events({
