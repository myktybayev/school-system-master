...
import './olympiadAllRepublicResults.html';

Template.olympiadAllRepublicResults.onCreated(function() {
    let template = this
...
Template.olympiadAllRepublicResults.helpers({
    schools()  {
...
Template.olympiadAllRepublicResults.events({
