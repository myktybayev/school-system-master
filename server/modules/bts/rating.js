...
export const calculateRating = (academicYear,btsNo,day, schoolId) => {
    ...
    calculateBtsRatingForGrade = (academicYear,btsNo,schoolId,grade) => {
        ...
        if (ratingObj.grade == '7'){
          ...
          if (firstDayCounter != 0) {
              ...
              // ratingObj.geographyA = (ratingObj.geographyA / electiveGroup_1_Count)
              // ratingObj.geographyB = (ratingObj.geographyB / electiveGroup_1_Count)

              ratingObj.physics   = ratingObj.physics / (electiveGroup_1_Count+electiveGroup_4_Count+electiveGroup_5_Count)
              // ratingObj.physicsA = (ratingObj.physicsA / electiveGroup_1_Count)
              // ratingObj.physicsB = (ratingObj.physicsB / electiveGroup_1_Count)
              ratingObj.chemistry = ratingObj.chemistry / (electiveGroup_2_Count+electiveGroup_4_Count+electiveGroup_6_Count)
              // ratingObj.chemistryA = (ratingObj.chemistryA / electiveGroup_2_Count)
              // ratingObj.chemistryB = (ratingObj.chemistryB / electiveGroup_2_Count)
              ratingObj.biology = ratingObj.biology / (electiveGroup_4_Count+electiveGroup_5_Count+electiveGroup_6_Count)
              // ratingObj.biologyA = (ratingObj.biologyA / electiveGroup_3_Count)
              // ratingObj.biologyB = (ratingObj.biologyB / electiveGroup_3_Count)
              ...
              /*
              if(electiveGroup_1_Count){
                console.log("firstDayCounter ave record.electiveGroup == '01'");
                ratingObj.geography = (ratingObj.geography / electiveGroup_1_Count)
                ratingObj.geographyA = (ratingObj.geographyA / electiveGroup_1_Count)
                ratingObj.geographyB = (ratingObj.geographyB / electiveGroup_1_Count)

                ratingObj.physics   = (ratingObj.physics / electiveGroup_1_Count)
                ratingObj.physicsA = (ratingObj.physicsA / electiveGroup_1_Count)
                ratingObj.physicsB = (ratingObj.physicsB / electiveGroup_1_Count)

              }
              if(electiveGroup_2_Count){

                console.log("firstDayCounter ave record.electiveGroup == '02'");

                ratingObj.geography = (ratingObj.geography / (electiveGroup_2_Count + electiveGroup_1_Count)
                ratingObj.geographyA = (ratingObj.geographyA / (electiveGroup_2_Count + electiveGroup_1_Count)
                ratingObj.geographyB = (ratingObj.geographyB / (electiveGroup_2_Count + electiveGroup_1_Count)

                ratingObj.chemistry = (ratingObj.chemistry / electiveGroup_2_Count)
                ratingObj.chemistryA = (ratingObj.chemistryA / electiveGroup_2_Count)
                ratingObj.chemistryB = (ratingObj.chemistryB / electiveGroup_2_Count)

              }
              if(electiveGroup_3_Count){
                console.log("firstDayCounter ave record.electiveGroup == '03'");

                ratingObj.geography = (ratingObj.geography / electiveGroup_3_Count)
                ratingObj.geographyA = (ratingObj.geographyA / electiveGroup_3_Count)
                ratingObj.geographyB = (ratingObj.geographyB / electiveGroup_3_Count)

                ratingObj.biology = (ratingObj.biology / electiveGroup_3_Count)
                ratingObj.biologyA = (ratingObj.biologyA / electiveGroup_3_Count)
                ratingObj.biologyB = (ratingObj.biologyB / electiveGroup_3_Count)

              }
              if(electiveGroup_4_Count){
                console.log("firstDayCounter ave record.electiveGroup == '04'");

                ratingObj.physics   = (ratingObj.physics / (electiveGroup_4_Count + electiveGroup_1_Count)
                ratingObj.physicsA = (ratingObj.physicsA / (electiveGroup_4_Count + electiveGroup_1_Count)
                ratingObj.physicsB = (ratingObj.physicsB / (electiveGroup_4_Count + electiveGroup_1_Count)

                ratingObj.chemistry = (ratingObj.chemistry / (electiveGroup_4_Count + electiveGroup_2_Count)
                ratingObj.chemistryA = (ratingObj.chemistryA / (electiveGroup_4_Count + electiveGroup_2_Count)
                ratingObj.chemistryB = (ratingObj.chemistryB / (electiveGroup_4_Count + electiveGroup_2_Count)
              }
              if(electiveGroup_5_Count){
                console.log("firstDayCounter ave record.electiveGroup == '05'");

                ratingObj.physics   = (ratingObj.physics / electiveGroup_5_Count)
                ratingObj.physicsA = (ratingObj.physicsA / electiveGroup_5_Count)
                ratingObj.physicsB = (ratingObj.physicsB / electiveGroup_5_Count)

                ratingObj.biology = (ratingObj.biology / electiveGroup_5_Count)
                ratingObj.biologyA = (ratingObj.biologyA / electiveGroup_5_Count)
                ratingObj.biologyB = (ratingObj.biologyB / electiveGroup_5_Count)

              }
              if(electiveGroup_6_Count){
                console.log("firstDayCounter ave record.electiveGroup == '06'");
                ratingObj.chemistry = (ratingObj.chemistry / electiveGroup_6_Count)
                ratingObj.chemistryA = (ratingObj.chemistryA / electiveGroup_6_Count)
                ratingObj.chemistryB = (ratingObj.chemistryB / electiveGroup_6_Count)

                ratingObj.biology = (ratingObj.biology / electiveGroup_6_Count)
                ratingObj.biologyA = (ratingObj.biologyA / electiveGroup_6_Count)
                ratingObj.biologyB = (ratingObj.biologyB / electiveGroup_6_Count)

              }
              if(electiveGroup_7_Count){
                console.log("firstDayCounter ave record.electiveGroup == '07'");
                ratingObj.geography = (ratingObj.geography / electiveGroup_7_Count)
                ratingObj.geographyA = (ratingObj.geographyA / electiveGroup_7_Count)
                ratingObj.geographyB = (ratingObj.geographyB / electiveGroup_7_Count)
    ...
    console.log("sameSchoolRating2: "+sameSchoolRating2);
